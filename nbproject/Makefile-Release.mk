...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/gspeakdaemon: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/gspeakdaemon ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/_ext/1396912672/config.o: /root/NetBeansProjects/gSpeakDaemon/config.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1396912672
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1396912672/config.o /root/NetBeansProjects/gSpeakDaemon/config.cpp

${OBJECTDIR}/_ext/1396912672/processDaemon.o: /root/NetBeansProjects/gSpeakDaemon/processDaemon.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1396912672
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1396912672/processDaemon.o /root/NetBeansProjects/gSpeakDaemon/processDaemon.cpp
...
${OBJECTDIR}/speak.o: speak.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/speak.o speak.cpp
